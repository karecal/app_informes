...
import styles from './BienFormPage.module.css'
...
function BienFormPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${import.meta.env.VITE_API_URL}/bienes`, {
        method: 'POST',
        headers: {
  ...
  return (
    <div className={styles.container}>
      ...
      <h1 className={styles.title}>Nuevo bien patrimonial</h1>
      ...
      <form onSubmit={handleSubmit} className={styles.form}>
        ...
        <div className={styles.field}>
          ...
          <input
            ...
            placeholder="Ej: Retablo de San Cristóbal"
            required
          />
        </div>
        ...
        <div className={styles.field}>
          ...
          <textarea
            ...
            onChange={handleChange}
            rows={4}
            placeholder="Descripción del bien patrimonial"
          />
        </div>

        <button type="submit" className={styles.submitBtn} disabled={submitting}>
          {submitting ? 'Guardando...' : 'Crear bien'}
        </button>
      </form>
    </div>
  )
